...
// The hall-effect flow sensor outputs approximately 3.2 pulses per second per
// litre/minute of flow.
float calibrationFactor = 3.19488;
...
void loop()
{
  ...
  { 
    ...
    Serial.print(int(flowRate), DEC);  // Print the integer part of the variable
